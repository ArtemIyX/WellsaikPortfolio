...
<template>
  <main class="debug-view">
    ...
    <section class="debug-section" aria-labelledby="type-title">
      <div class="section-heading"><div><p class="eyebrow">03 / Typography</p><h2 id="type-title">IBM Plex Mono specimens.</h2></div><p class="section-note">Self-hosted weight files with system fallbacks.</p></div>
      ...
      <div class="token-list"><code>--font-body</code><span>IBM Plex Mono, Cascadia Mono, Consolas, monospace</span><code>--font-size-body</code><span>1rem / line-height 1.65</span><code>--measure</code><span>68ch reading width</span></div>
    </section>
  </main>
</template>
